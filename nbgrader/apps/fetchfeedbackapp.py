...
class FetchFeedbackApp(NbGrader):
    ...
    examples = """
        ...
        To fetch feedback, you must first know the `course_id` for your course.
        If you don't know it, ask your instructor.  Then, simply include the
        argument with the '--course' flag.
